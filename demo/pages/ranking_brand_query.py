...
def page():
    ...
    if query:
        ...
        query_analyzed_res = get_analyze_result(ES, query, analyzers=["korean", "korean_syn"])
        brand_query_res = copy.deepcopy(query_analyzed_res)
        del query_analyzed_res['brand_keyword']
        st.write(query_analyzed_res)
