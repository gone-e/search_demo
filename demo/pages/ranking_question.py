...
# import demo.question.utils as question_utils
import demo.question.constants as constants
import demo.question.view as question_view
...
def page():
    """ 내외부 공유 용도의 페이지 """
    st.title("🧑🏻‍🏫 질문과답변 검색(Question Search) 데모")
    ...
    if query:
        ...
        st.subheader("[질문과답변 기준] 모바일앱: 1-4개 결과 / 웹: 8개 결과")
        st.subheader((
            f"Result"
