...
# import demo.advice.utils as advice_utils
import demo.advice.constants as constants
import demo.advice.view as advice_view
...
def page():
    """ 내외부 공유 용도의 페이지 """
    st.title("☔️ 노하우 검색(Advice Search) 데모")
    ...
    if query:
        ...
        st.subheader("[노하우 기준] 모바일앱: 4-5개 결과 / 웹: 8개 결과")
        st.subheader((
            f"Result"
