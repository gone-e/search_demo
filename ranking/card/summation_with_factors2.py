    ...
    return {
        ...
        "query": {
            "function_score": {
                                ...
                                "query": {
                                    "bool": {
                                        ...
                                        "should": [
                                            ...
                                            # NOTE: 부분매칭도 점수 주기(minimum_should_match %, length)
                                            {
                                                "match": {
                                                    "click_keywords": {
                                                        "query": query,
                ...
                # TODO: description 존재여부 없으면 패널티: https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-exists-query.html
                # TODO: 해시태그 개수가 상품개수나 설명에 비해 너무 많으면 패널티?
                # TODO: view count가 0인 관련성 높은 문서들이 너무 많은 문제?
                # TODO: 인기도 등의 피쳐 수정(예: 복합관계, 시간 정규화, 추가피쳐), Weight 학습
                # TODO: field_value_factor나 다른 쿼리절도 쉽게 사용가능하도록(예: multiple script_score + score_mode=sum + function_score)
                "functions": [
                    {
                        "script_score": {
