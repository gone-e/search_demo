            ...
            "function_score": {
                ...
                "script_score": {
                    "script": {
                        ...
                        # "source": """
                        # 0.5 * _score \
                        # + 0.1 * doc['created_at_score'].value \
                        # + 0.1 * doc['follower_score'].value \
                        # + 0.1 * doc['scrap_score'].value \
                        # + 0.1 * doc['view_count_score'].value \
                        # + 0.1 * Math.log(1 + doc['reply_count'].value) \
                        # + 0.1 * Math.log(1 + doc['share_count'].value)
                        # """
